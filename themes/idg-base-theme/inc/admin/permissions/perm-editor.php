<?php
if ( ! function_exists( 'idg_role_editor_capabilities' ) ) {
	/**
	 * `editor` role capabilities.
	 * Only includes capability differences to standard WordPress `editor` role.
	 *
	 * @see https://wordpress.org/support/article/roles-and-capabilities/#capability-vs-role-table
	 */
	function idg_role_editor_capabilities() {
...
add_action( 'after_switch_theme', 'idg_role_editor_capabilities' );
