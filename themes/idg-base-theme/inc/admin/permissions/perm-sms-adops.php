<?php
/**
 * Assigns `sms_adops` role capabilities
 */
add_filter(
	'idg_role_sms_adops_capabilities',
	function ( $capabilities = [] ) {
		$capabilities = [
			...
			'manage_asset_tag'          => false,
			'edit_asset_tag'            => false,
			'delete_asset_tag'          => false,
			'assign_asset_tag'          => true,

			'manage_asset_image_rights' => false,
			'edit_asset_image_rights'   => false,
