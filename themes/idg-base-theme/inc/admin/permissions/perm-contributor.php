<?php
if ( ! function_exists( 'idg_role_contributor_capabilities' ) ) {
	/**
	 * `contributor` role capabilities.
	 * Only includes capability differences to standard WordPress `contributor` role.
	 *
	 * @see https://wordpress.org/support/article/roles-and-capabilities/#capability-vs-role-table
	 */
	function idg_role_contributor_capabilities() {
...
add_action( 'after_switch_theme', 'idg_role_contributor_capabilities' );
