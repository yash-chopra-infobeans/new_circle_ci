...
if ( class_exists( 'IDG_Article_Type_Rest' ) ) {
	return new IDG_Article_Type_Rest();
}

/**
 * Class to register custom rest route for `article_type`
 * taxonomy with better child/parent heirachy.
 */
class IDG_Article_Type_Rest {
	...
	/**
	 * Gets all article types: `article_type`
	 *
	...
	/**
	 * Sorts parent article types and their children into an array
	 *
