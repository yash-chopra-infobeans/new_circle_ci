...
if ( class_exists( 'IDG_Story_Types_Rest' ) ) {
	return new IDG_Story_Types_Rest();
}

/**
 * Class to register custom rest route for `story_types`
 * taxonomy with better child/parent heirachy.
 */
class IDG_Story_Types_Rest {
	...
	/**
	 * Gets all story types: `story_types`
	 *
	...
	/**
	 * Sorts parent story types and their children into an array
	 *
