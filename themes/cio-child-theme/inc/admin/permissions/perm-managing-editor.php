<?php
if ( ! function_exists( 'idg_role_managing_editor_capabilities' ) ) {
	/**
	 * `managing_editor` role capabilities.
	 * Only includes capability differences to idg-base-theme `managing_editor` role.
	 */
	function idg_role_managing_editor_capabilities() {
...
add_action( 'after_switch_theme', 'idg_role_managing_editor_capabilities' );
