<?php
if ( ! function_exists( 'idg_role_design_capabilities' ) ) {
	/**
	 * `design` role capabilities.
	 * Only includes capability differences to idg-base-theme `design` role.
	 */
	function idg_role_design_capabilities() {
		$role = get_role( 'design' );
...
add_action( 'after_switch_theme', 'idg_role_design_capabilities' );
