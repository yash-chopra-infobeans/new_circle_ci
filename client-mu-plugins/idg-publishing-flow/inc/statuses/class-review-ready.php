...
/**
 * Handles any status changes registered as "Ready for Review".
 *
 * @inheritDoc
 */
class Review_Ready  extends Status implements Transition_Interface {
	use Transition;
